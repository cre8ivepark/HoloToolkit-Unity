...
namespace HoloToolkit.UI.Keyboard
{
	...
	public class Keyboard : MonoBehaviour
	{
        ...
        /// The panel that contains the alpha keys.
        /// </summary>
        public Image AlphaJPHiraganaKeyboard = null;

        /// <summary>
        /// The panel that contains the alpha keys.
        /// </summary>
        public Image AlphaJPKatakanaKeyboard = null;
        ...
        /// References abc bottom panel.
        /// </summary>
        public Image AlphaJPSubKeys = null;
		...
		private LayoutType m_LastKeyboardLayout = LayoutType.AlphaJP_Hiragana;
        ...
        /// Event fired when shift key on keyboard is pressed.
        /// </summary>
        public event Action<bool> onKeyboardShifted2 = delegate { };
        ...
        /// <summary>
        /// Current shift2 state of keyboard.
        /// </summary>
        private bool m_IsShifted2 = false;
        ...
        /// Accessor reporting shift state of keyboard.
        /// </summary>
        public bool IsShifted2
        {
            get { return m_IsShifted2; }
        }
        ...
        private void ActivateSpecificKeyboard(LayoutType keyboardType)
        {
			...
			switch (keyboardType)
			{
                ...
                case LayoutType.AlphaJP_Hiragana:
                {
                    ShowAlphaJPHiraganaKeyboard();
                    TryToShowAlphaJPSubkeys();
                    break;
                }

                case LayoutType.AlphaJP_Katakana:
                {
                        ShowAlphaJPKatakanaKeyboard();
                        TryToShowAlphaJPSubkeys();
                        break;
                }
		...
		public void AppendValue(KeyboardValueKey valueKey)
		{
            ...
            else if (m_IsShifted2 && !string.IsNullOrEmpty(valueKey.ShiftValue2))
            {
                value = valueKey.ShiftValue2;
            }
            else
			{
		...
		public void FunctionKey(KeyboardKeyFunc functionKey)
		{
			switch (functionKey.m_ButtonFunction)
			{
                ...
                case KeyboardKeyFunc.Function.JPNHiragana:
                {
                    ActivateSpecificKeyboard(LayoutType.AlphaJP_Hiragana);
                    break;
                }

                case KeyboardKeyFunc.Function.JPNKatakana:
                {
                    ActivateSpecificKeyboard(LayoutType.AlphaJP_Katakana);
                    break;
                }
                ...
                case KeyboardKeyFunc.Function.Shift2:
                {
                    Shift2(!m_IsShifted2);
                    break;
                }
        ...
        /// </summary>
        /// <param name="newShiftState"></param>
        public void Shift2(bool newShiftState)
        {
            m_IsShifted2 = newShiftState;
            onKeyboardShifted2(m_IsShifted2);
        ...
        /// Enable the alpha keyboard.
        /// </summary>
        public void ShowAlphaJPHiraganaKeyboard()
        {
            AlphaJPHiraganaKeyboard.gameObject.SetActive(true);
            m_LastKeyboardLayout = LayoutType.AlphaJP_Hiragana;
        }

        /// <summary>
        /// Enable the alpha keyboard.
        /// </summary>
        public void ShowAlphaJPKatakanaKeyboard()
        {
            AlphaJPKatakanaKeyboard.gameObject.SetActive(true);
            m_LastKeyboardLayout = LayoutType.AlphaJP_Katakana;
        }
        ...
        /// </summary>
        /// <returns></returns>
        private bool TryToShowAlphaJPSubkeys()
        {
            if (AlphaJPHiraganaKeyboard.IsActive() || AlphaJPKatakanaKeyboard.IsActive())
            {
                AlphaJPSubKeys.gameObject.SetActive(true);
                return true;
            }
            else
            {
		...
		{
			if (AlphaKeyboard.IsActive() || AlphaJPHiraganaKeyboard.IsActive() || AlphaJPKatakanaKeyboard.IsActive())
			{
		...
		private void DisableAllKeyboards()
		{
            ...
            AlphaJPHiraganaKeyboard.gameObject.SetActive(false);
            AlphaJPKatakanaKeyboard.gameObject.SetActive(false);
            ...
            AlphaJPSubKeys.gameObject.SetActive(false);
        }
